...
// A commercial platform for selling instances released by the MCDManager Dev Team.
// Currently, it only supports some countries and regions.
// If you do not turn on "Commercial Mode", MCDManager will not send any data.
